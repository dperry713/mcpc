...
mod tests {
    ...
    fn test_planner_incremental() {
        let module_a = Module { name: "A".into(), module_type: None, entry: None, features: vec![], dependencies: vec![], dependents: vec![], meta: None };
        let module_b = Module { name: "B".into(), module_type: None, entry: None, features: vec![], dependencies: vec!["A".into()], dependents: vec![], meta: None };
